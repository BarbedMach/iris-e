...
int main(int argc, char** argv) {
  ...
  iris_task_submit(task0, iris_client, NULL, false);
  iris_task_submit(task1, iris_client, NULL, false);
  iris_task_submit(task2, iris_client, NULL, false);
  iris_task_submit(task3, iris_client, NULL, false);
